...
# Dotpulse.Accordion Package for Neos CMS #

## Composer

### Integration Repository
```
composer config repositories.button vcs ssh://hg@bitbucket.org/dotpulse/neos-plugin-accordion
```

### Installation
```
composer require dotpulse/accordion
```
* * *
> ##### License Terms
